...
public class TrentinoTips implements java.io.Serializable {
	...
	private ArrayList<CompleteTip[]> results = new ArrayList<CompleteTip[]>();
	...
	public void executeBatchTipQueries(ArrayList<String> geopoints, String serialization_file){
		  ...
		  //foursquare
		  FoursquareApi foursquareApi1 = new FoursquareApi("K2UZAGK0N1SL3FL0VKIZYKYE0Z0LM00SKVSDUMZYK52TQFDU","JQPG10CIZQC0NYXGK4AQY40NKT4JVKPFEHSMQ4PGRPSDFVNV",  "https://www.foursquare.com");
		  ...
		  try {
			this.serialiseTips(serialization_file);
		  } catch (IOException e) {
	  ...
	  public static void main(String[] args) {
		...
		if(deserialize){
			try {
				tt=deserialiseTips("./storage/foursquare_output _24Jan2014_complete one.ser");
